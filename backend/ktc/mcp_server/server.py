"""Kor Travel Concierge MCP 서버 엔트리포인트."""
...
from ktc.mcp_server.tools import ToolRuntime, register_mcp_tools, tool_metadata
...
def build_server(*, session_factory: Any = async_session_factory):
    ...
    server = FastMCP(
        ...
        instructions=(
            "Kor Travel Concierge 여행 데이터베이스를 조회하고 수집, 보정, 병합, "
